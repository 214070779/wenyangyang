...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    // bodyBgImg: [
    //   'https://cdn.jsdelivr.net/gh/214070779/publicPicture@master/a30084f5610d9b13f6779a353b2ee4bd.2qg4o03stt00.webp'
    ...
    author: {
      name: '洋仔', // 必需
      link: 'https://github.com/214070779', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://cdn.jsdelivr.net/gh/214070779/publicPicture@master/pingtou.5ytkqlpmd940.webp',
      name: '洋仔',
      slogan: '奋斗的小青年',
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:yangzai2140@163.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/214070779',
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
